      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-2 md:grid-cols-4 gap-gutter">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-2 text-body-sm text-text-secondary">
            ...
            <li><a className="hover:text-primary transition-colors duration-300" href="#">Soporte</a></li>
            <li><a className="hover:text-primary transition-colors duration-300" href="#">Contacto</a></li>
          </ul>
        </div>
        <div className="space-y-4">
          <h4 className="font-headline-md text-body-lg text-text-primary">Legal</h4>
          <ul className="space-y-2 text-body-sm text-text-secondary">
            <li><a className="hover:text-primary transition-colors duration-300" href="#">Privacidad</a></li>
            <li><a className="hover:text-primary transition-colors duration-300" href="#">Términos</a></li>
          </ul>
        </div>
      </div>
