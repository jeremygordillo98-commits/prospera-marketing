...
export default function FinancialHealthPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] p-4 sm:p-12 flex items-center justify-center selection:bg-[#00D68F] selection:text-white">
      <div className="w-full max-w-2xl bg-[#0F172A] rounded-[3rem] border border-slate-700/50 p-8 sm:p-12 shadow-2xl relative transition-all hover:border-[#00D68F]/30 overflow-hidden">
