  ...
  return (
    <div className="min-h-screen text-[#dfe2f1] font-body-md selection:bg-primary-container selection:text-white overflow-x-hidden flex flex-col justify-between">
      ...
      <main className="pt-32 pb-20 px-margin-mobile md:px-margin-desktop flex-1 flex items-center justify-center">
        <div className="w-full max-w-3xl glass-card rounded-[3rem] border border-glass p-8 sm:p-12 shadow-2xl relative overflow-hidden transition-all duration-300 hover:border-primary/30">
          <div className="absolute inset-0 bg-gradient-to-tr from-primary/5 via-transparent to-transparent opacity-50 pointer-events-none"></div>
